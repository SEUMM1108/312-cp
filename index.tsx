...
import OpenAI from "openai"; // 改动1：引入 OpenAI
import html2canvas from "html2canvas";

// 改动2：初始化通义千问客户端
// 注意：前端直接调用需要 dangerouslyAllowBrowser: true
...
2.  **人设还原：** 还原Boss组、博士组、硕士/本科组的特质。
3.  **风格执行：** 严格执行【${selectedStyle}】。
4.  **篇幅控制：** 目标字数在 **${targetWordCount}** 字左右。
5.  **拒绝OOC（Out Of Character）：** 保持符合东南大学工科生的行为逻辑。
